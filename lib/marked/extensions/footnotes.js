module.exports.footnoteReference = {
  ...
  renderer (token) {
    return `<a id="fnref:${token.label}" class="govuk-link" href="#fn:${token.label}" aria-describedby="footnotes-label">${token.text}</a>`
  }
}
...
module.exports.footnotes = {
  ...
  renderer (token) {
    return `<footer>
      ...
      <ol class="govuk-list app-list--footnotes">
        ${token.body}
      </ol>
    </footer>`
  }
